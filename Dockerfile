...
COPY --from=build /usr/src/target/fdx-mock-resource-server-*.jar /usr/src/app/fdx-mock-resource-server.jar
COPY src/main/resources /usr/src/app/src/main/resources


CMD java -jar /usr/src/app/fdx-mock-resource-server.jar
EXPOSE 9090 9091
