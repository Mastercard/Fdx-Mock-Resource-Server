...
class FdxResourceServiceTest {
	...
	@Test
	void testValidateTokenWithRequestAccountIdEx(){
		assertThrows(ApiException.class, () -> fdxResourceService.validateTokenWithRequestAccountId("testAccountId","testToken"));
	}

	@Test
	void testValidateTokenWithRequestAccountId() throws ApiException {
		assertDoesNotThrow(() -> fdxResourceService.validateTokenWithRequestAccountId(authorization,"20001"));
	}
}
